...
* Make sure that the clickData, runInfo, and trackAllData, and images folders are in the same directory as the jupyter notebook. Create a new empty folder called 'output' and put that in the same directory also.
